...
class _OrderPage extends State<OrderPage> {
  final formatter = new inter.NumberFormat("#,###");
  final formatWeight = new inter.NumberFormat("#,###.##");
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        title: Column(
                          children: <Widget>[
                            Text(
                              "جنيه ${formatter.format(model.bulkOrder[index].total)}",
                              style: TextStyle(
                                  color: Colors.green,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 11),
                            ...
                            Text(
                              "نقاط ${formatter.format(model.bulkOrder[index].totalBp)}",
                              style: TextStyle(
                                  color: Colors.red,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 11),
                            ...
                            Text(
                              "كغ ${formatWeight.format(model.bulkOrder[index].weight)}",
                              style: TextStyle(
                                  color: Colors.black,
                                  fontWeight: FontWeight.bold,
                                  fontSize: 11),
                              ...
                              leading: Container(
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Text(
                                      ' جنيه ${formatter.format(model.bulkOrderSum())}',
                                      style: TextStyle(
                                        color: Colors.green,
                                        fontSize: 13.0,
                                        fontWeight: FontWeight.bold,
                                    ...
                                    Text(
                                      ' نقاط ${formatter.format(model.bulkOrderBp())}',
                                      style: TextStyle(
                                    ...
                                    Text(
                                      ' كغ ${formatWeight.format(model.bulkOrderWeight())}',
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 13.0,
                                        fontWeight: FontWeight.bold,
                    ...
                    leading: Container(
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              'جنيه ${formatter.format(model.orderSum())}',
                            ...
                            !widget.model.user.isGuest
                                ? Text(
                                    'نقاط ${formatter.format(model.orderBp())}',
                                    textAlign: TextAlign.right,
                                    textDirection: TextDirection.rtl,
                                    style: TextStyle(
                                      color: Colors.pink[800],
                            ...
                            Text(
                              'كغ ${formatWeight.format(model.orderWeight())}',
                              textAlign: TextAlign.right,
                              textDirection: TextDirection.rtl,
                              style: TextStyle(
                                color: Colors.black,
...
Widget _orderExp(BuildContext context, MainModel model,
    inter.NumberFormat formatter, inter.NumberFormat formatWeight) {
  return Expanded(
      child: model.itemorderlist.length != 0
          ? ListView.builder(
                                      ...
                                      children: <Widget>[
                                        Flex(
                                            ...
                                            children: <Widget>[
                                              Text(
                                                !model.user.isGuest
                                                    ? 'جنيه ${formatter.format(model.itemorderlist[i].totalPrice)}'
                                                    : 'جنيه ${formatter.format(model.itemorderlist[i].guestTotalPrice)}',
                                                style: TextStyle(
                                                  fontSize: 13.0,
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.green[700],
                                              ...
                                              Column(
                                                children: <Widget>[
                                                  !model.user.isGuest
                                                      ? Text(
                                                          'نقاط ${model.itemorderlist[i].totalBp.toString()}',
                                                          style: TextStyle(
                                                            fontSize: 13.0,
                                                            color:
                                                                Colors.red[900],
                                                  ...
                                                  Text(
                                                    'كغ ${formatWeight.format(model.itemorderlist[i].totalWeight)}',
                                                    style: TextStyle(
                                                      fontSize: 13.0,
                                                      color: Colors.black,
                                                      fontWeight:
  ...
  return !model.iheld(model.getItemIndex(i))
      ? IconButton(
          icon: Badge(
            ...
            animationType: BadgeAnimationType.scale,
            badgeContent: Text(
              '${model.itemorderlist[i].qty <= 0 ? 0 : model.itemorderlist[i].qty}',
              style: TextStyle(color: Colors.white),
            ),
