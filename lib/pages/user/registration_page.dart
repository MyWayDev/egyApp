...
//!legacy distrid check for exists
  ...
  Future initlegacyData(String distrid) async {
    User user = await model.memberJson(distrid.padLeft(8, '0'));
                ...
                children: <Widget>[
                  /*Container(
                    ...
                    child: TextButton.icon(
                      ...
                      onPressed: () {
                        model.updateGuestPriceFB();
                        //model.getTickets(1);
                        //model.fbItemsUpdateFromDbIndo();
                        //model.fbItemsUpdateFromDbMorc(); //! Morc fb items update
